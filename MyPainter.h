...
public:
    ...
    void triangle(Vec3i t0, Vec3i t1, Vec3i t2, float ity0, float ity1, float ity2, Image &image, int *zbuffer)
    {
...
//        std::cerr << z << std::endl;
        ...
        for (int i=0; i<model->nfaces(); i++) {
            ...
            triangle(screen_coords[0], screen_coords[1], screen_coords[2], intensity[0], intensity[1], intensity[2], image, _zbuffer.data());
        }
    }
